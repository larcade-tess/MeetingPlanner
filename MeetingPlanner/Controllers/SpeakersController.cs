...
namespace MeetingPlanner.Controllers
{
    public class SpeakersController : Controller
    {
        ...
        {
            var meetingContext = _context.Speakers.Include(s => s.Bulletin);
        ...
        {
            ViewData["BulletinID"] = new SelectList(_context.Bulletins, "ID", "ID");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SpeakerID,BulletinID,Name,Topic")] Speaker speaker)
        {
